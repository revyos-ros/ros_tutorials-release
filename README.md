...
The packages in the `ros_tutorials` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy ros_tutorials --override-release-repository-push-url git@github.com:revyos-ros/ros_tutorials-release.git` on `Mon, 17 Jun 2024 04:09:46 -0000`
...
- release repository: https://github.com/revyos-ros/ros_tutorials-release.git
